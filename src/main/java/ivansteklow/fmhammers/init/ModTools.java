...
public class ModTools {
	...
	public static Item woodenHammer, stoneHammer, ironHammer, goldenHammer, diamondHammer,
			starmetalHammer/*
							 * , stoneDrill, ironDrill, goldenDrill,
							 * diamondDrill, starmetalDrill
							 */;
	...
	public static void init() {
		...
		/*
		 * stoneDrill = new ItemDrill(ToolMaterial.STONE, 1, 9, 5); ironDrill =
		 * new ItemDrill(ToolMaterial.IRON, 1, 9, 10); goldenDrill = new
		 * ItemDrill(ToolMaterial.GOLD, 1, 10, 5); diamondDrill = new
		 * ItemDrill(ToolMaterial.DIAMOND, 9, 9, 25); starmetalDrill = new
		 * ItemDrill(Refs.STARMETAL, 1, 20, 25);
		 * 
